<div class="home_contact">
    <div class="home_contact_header"><a href="/office/furniture/contact-us">CONTACT US</a> </div>
    <div class="home_contact_address">
        <div class="bx-wrapper" style="max-width: 100%;">
            <div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 160px;">
                <ul class="bxslider" style="width: 715%; position: relative; transition-duration: 0s; transform: translate3d(-255px, 0px, 0px);">
                    <li style="float: left; list-style: none; position: relative; width: 254px;" class="bx-clone">
                        <div class="bxslider_address">
                            <span class="bxslider_address_header">Abu Dhabi Branch
                            </span>
                            
                            
                               Airport Road - Abu Dhabi<br>
                            
                            Tel. No.: 02 4467671<br>
                            
                            Fax No.: 02 4467672<br>
                    ...
                    <li style="float: left; list-style: none; position: relative; width: 254px;">
                        <div class="bxslider_address">
                            <span class="bxslider_address_header">Bur Dubai Branch
                            </span>
                            
                            
                               Al Karama - Dubai - United Arab Emirates<br>
                            
                            Tel. No.: 04 3341433<br>
                            
                            Fax No.: 04 3341417<br>
